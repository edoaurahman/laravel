...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2022 at 10:26 AM
...
--
-- Table structure for table `available_vaccines`
--

CREATE TABLE `available_vaccines` (
  `id` int(11) NOT NULL,
  `spot_id` int(11) NOT NULL,
  `Sinovac` enum('true','false') NOT NULL,
  `AstraZeneca` enum('true','false') NOT NULL,
  `Moderna` enum('true','false') NOT NULL,
  `Pfizer` enum('true','false') NOT NULL,
  `Sinnopharm` enum('true','false') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `available_vaccines`
--

INSERT INTO `available_vaccines` (`id`, `spot_id`, `Sinovac`, `AstraZeneca`, `Moderna`, `Pfizer`, `Sinnopharm`) VALUES
...
(40, 1, NULL, 'accepted', NULL, 'pregnant', NULL),
(47, 6, NULL, 'accepted', 'Asma', 'Flu', NULL);
...
(1, '20210001', '121212', 'Omar Gunawan', '1990-04-18', 'male', 'Jln. Baranang Siang No. 479, DKI Jakarta', 1, 'd9d09b1f57dcb100fe69c98c93f37de4'),
...
(6, '20210006', '121212', 'Jail Utama', '2001-12-28', 'male', 'Kpg. Cikutra Timur No. 57, DKI Jakarta', 1, '468c0366ed4c960b1eab2c52f5b65088'),
...
INSERT INTO `vaccinations` (`id`, `dose`, `date`, `society_id`, `spot_id`, `vaccine_id`, `doctor_id`, `officer_id`, `status`) VALUES
(1, 1, '2021-10-25', 7, 2, NULL, NULL, NULL, 'pending'),
(2, 1, '2021-10-25', 8, 5, NULL, NULL, NULL, 'pending'),
(3, 1, '2021-09-01', 9, 3, 1, 23, 10, 'pending'),
(4, 1, '2021-09-01', 10, 4, 5, 21, 15, 'pending'),
(5, 1, '2021-09-01', 11, 4, 5, 16, 25, 'pending'),
(6, 2, '2021-10-27', 11, 5, NULL, NULL, NULL, 'pending'),
(7, 1, '2021-09-01', 12, 5, 1, 8, 24, 'pending'),
(8, 2, '2021-10-27', 12, 2, NULL, NULL, NULL, 'pending'),
(9, 1, '2021-09-01', 13, 1, 5, 2, 14, 'pending'),
(10, 2, '2021-10-27', 13, 4, 1, 1, 15, 'pending'),
(11, 1, '2021-09-01', 14, 3, 5, 21, 15, 'pending'),
(12, 2, '2021-10-27', 14, 3, 1, 22, 15, 'pending'),
(13, 1, '2021-10-25', 22, 7, NULL, NULL, NULL, 'pending'),
(14, 1, '2021-10-25', 23, 9, NULL, NULL, NULL, 'pending'),
(15, 1, '2021-09-01', 24, 9, 3, 46, 50, 'pending'),
(16, 1, '2021-09-01', 25, 8, 5, 28, 40, 'pending'),
(17, 1, '2021-09-01', 26, 6, 5, 31, 29, 'pending'),
(18, 2, '2021-10-27', 26, 8, NULL, NULL, NULL, 'pending'),
(19, 1, '2021-09-01', 27, 6, 2, 38, 39, 'pending'),
(20, 2, '2021-10-27', 27, 8, NULL, NULL, NULL, 'pending'),
(21, 1, '2021-09-01', 28, 8, 2, 48, 44, 'pending'),
(22, 2, '2021-10-27', 28, 6, 5, 46, 44, 'pending'),
(23, 1, '2021-09-01', 29, 10, 3, 38, 30, 'pending'),
(24, 2, '2021-10-27', 29, 9, 2, 37, 30, 'pending'),
(25, 1, '2021-10-25', 37, 13, NULL, NULL, NULL, 'pending'),
(26, 1, '2021-10-25', 38, 15, NULL, NULL, NULL, 'pending'),
(27, 1, '2021-09-01', 39, 11, 4, 72, 59, 'pending'),
(28, 1, '2021-09-01', 40, 12, 2, 62, 59, 'pending'),
(29, 1, '2021-09-01', 41, 15, 1, 56, 70, 'pending'),
(30, 2, '2021-10-27', 41, 15, NULL, NULL, NULL, 'pending'),
(31, 1, '2021-09-01', 42, 12, 2, 66, 54, 'pending'),
(32, 2, '2021-10-27', 42, 15, NULL, NULL, NULL, 'pending'),
(33, 1, '2021-09-01', 43, 13, 3, 52, 65, 'pending'),
(34, 2, '2021-10-27', 43, 14, 4, 52, 64, 'pending'),
(35, 1, '2021-09-01', 44, 13, 3, 52, 54, 'pending'),
(36, 2, '2021-10-27', 44, 14, 4, 53, 54, 'pending'),
(37, 1, '2021-12-25', 1, 1, 1, 1, NULL, 'done'),
(47, 1, '2021-12-25', 1, 1, 1, 1, NULL, 'pending'),
(48, 1, '2021-09-01', 6, 1, NULL, NULL, NULL, 'pending'),
(49, 1, '2021-09-01', 6, 1, NULL, NULL, NULL, 'pending');
...
--
-- Indexes for table `available_vaccines`
--
ALTER TABLE `available_vaccines`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `available_vaccines`
--
ALTER TABLE `available_vaccines`
